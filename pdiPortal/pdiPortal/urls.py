...
urlpatterns = [
    ...
    url(r'^device-list/(?P<username>\w+)$', management_views.devices_for_user.as_view(), name='device-list-for-user'),
    ...
    url(r'^users/$', management_views.users.as_view(), name='users'),
    url(r'^users/(?P<username>\w+)/$', management_views.user_configuration, name="user-configuration"),
    url(r'^create/facilityadmin/$', facility_views.create_facility_admin.as_view(), name='create-admin'),
    url(r'^create/user/$', facility_views.create_user.as_view(), name='create-user'),
